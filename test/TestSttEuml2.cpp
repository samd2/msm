...
BOOST_AUTO_TEST_CASE( test_stt )
{
    ...
    BOOST_CHECK_MESSAGE(typeid(EUML2_ROW("foo + bar [aa] / bb -> foobar")::OrgTarget)== typeid(BOOST_MSM_EUML2_STATE("foobar",dummy_fsm)),"target not foobar");
    ...
    BOOST_CHECK_MESSAGE(typeid(EUML2_ROW("foo + bar -> tgt")::OrgTarget)== typeid(BOOST_MSM_EUML2_STATE("tgt",dummy_fsm)),"target not tgt");
    ...
    BOOST_CHECK_MESSAGE(typeid(EUML2_ROW("foo + bar / bb -> tgt")::OrgTarget)== typeid(BOOST_MSM_EUML2_STATE("tgt",dummy_fsm)),"target not tgt");
    ...
    BOOST_CHECK_MESSAGE(typeid(EUML2_ROW("foo + bar [aa] -> tgt")::OrgTarget)== typeid(BOOST_MSM_EUML2_STATE("tgt",dummy_fsm)),"target not tgt");
    ...
    BOOST_CHECK_MESSAGE(typeid(EUML2_ROW("foo + bar")::OrgTarget)== typeid(boost::msm::front::none),"target not none");
    ...
    BOOST_CHECK_MESSAGE(typeid(EUML2_ROW("foo + bar / bb")::OrgTarget)== typeid(boost::msm::front::none),"target not none");
    ...
    BOOST_CHECK_MESSAGE(typeid(EUML2_ROW("foo + bar [aa]")::OrgTarget)== typeid(boost::msm::front::none),"target not none");
    ...
    BOOST_CHECK_MESSAGE(typeid(EUML2_ROW("foo + bar [aa] / bb")::OrgTarget)== typeid(boost::msm::front::none),"target not none");
    ...
    BOOST_CHECK_MESSAGE(typeid(EUML2_INTERNAL("bar [aa] / bb -> foo")::Evt)== typeid(BOOST_MSM_EUML2_EVENT("bar",dummy_fsm)),"evt not bar");
    BOOST_CHECK_MESSAGE(typeid(EUML2_INTERNAL("bar [aa] / bb -> foo")::Action)== typeid(BOOST_MSM_EUML2_ACTION("bb")),"action not bb");
    BOOST_CHECK_MESSAGE(typeid(EUML2_INTERNAL("bar [aa] / bb -> foo")::Guard)== typeid(BOOST_MSM_EUML2_GUARD("aa")),"guard not aa");

    // anonymous transitions
    BOOST_CHECK_MESSAGE(typeid(EUML2_ROW("foo [aa] / bb -> foobar")::OrgTarget)== typeid(BOOST_MSM_EUML2_STATE("foobar",dummy_fsm)),"target not foobar");
    ...
    BOOST_CHECK_MESSAGE(typeid(EUML2_ROW("foo / bb -> tgt")::OrgTarget)== typeid(BOOST_MSM_EUML2_STATE("tgt",dummy_fsm)),"target not tgt");
    ...
    BOOST_CHECK_MESSAGE(typeid(EUML2_ROW("foo [aa] -> tgt")::OrgTarget)== typeid(BOOST_MSM_EUML2_STATE("tgt",dummy_fsm)),"target not tgt");
    ...
    BOOST_CHECK_MESSAGE(typeid(EUML2_ROW("foo -> tgt")::OrgTarget)== typeid(BOOST_MSM_EUML2_STATE("tgt",dummy_fsm)),"target not tgt");
